...
public class AssertForValidInvalid {
	
	public void ValdInput() {
		try {
			...
			Thread.sleep(2000);
			Email.sendKeys("myemailid01@gmail.com");
			Thread.sleep(2000);
			ConfirmEmail.sendKeys("myemailid01@gmail.com");
			Thread.sleep(2000);
			Username.sendKeys("MyUserName1");
			Thread.sleep(2000);
			...
			WebElement Register1 = driver.findElement(By.xpath("//h1[text()='Register']"));
			Assert.assertEquals(true, Register1.isDisplayed());		//Assert
			driver.quit();
		}catch(Exception ex) {
			ex.printStackTrace();
		}
	...
	public void InValid() {
		try {
			...
			LastName.sendKeys("MyLastName");
			Thread.sleep(2000);
			Email.sendKeys("myemailid008@gmail.com");
			Thread.sleep(2000);
			ConfirmEmail.sendKeys("myemailid008@gmail.com");
			Thread.sleep(2000);
			...
			WebElement TitleInvalid = driver.findElement(By.xpath("//h1[text()='Register']"));
			Assert.assertEquals(true, TitleInvalid.isDisplayed());		//Assert
			driver.quit();
		}catch(Exception ex) {
			ex.printStackTrace();
		}
	...
	public static void main(String[] args) {
		...
		AssertForValidInvalid obj = new AssertForValidInvalid();
		obj.ValdInput();	
		obj.InValid();
	}
}